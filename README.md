...
```
    ...
    W Twoim rozwiązaniu musi działać program demonstracyjny, wywoływany poleceniem java cp2023.demo.TransferBurst, to jest nie może on zgłaszać żadnych wyjątków.
```
